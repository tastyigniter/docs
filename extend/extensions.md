...
> We strongly recommend that you follow the [TastyIgniter coding standards](../resources/php-coding-guidelines.md) when creating your own extensions. It is a requirement for any changes to the TastyIgniter core code.
...
| **registerPermissions()**      | registers any [staff permissions](../extend/permissions.md#registering-permissions) supplied by this extension.            |
